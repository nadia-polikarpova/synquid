...
LOGFILE_NAME = 'run_medium.log'                                 # Log file
...
if __name__ == '__main__':
    ...
    # Run experiments
    # Note this version of the script only runs Synquid with all optimizations enabled and in benchmark-specific context; no variants!
